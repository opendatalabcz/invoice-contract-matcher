...
class TestContractProviderRegistr(TestCase):
    def test_get_file_name(self):
        self.assertEqual("dump_2020_10.xml", ContractProviderRegistr._get_file_name(year=2020, month=10))
        self.assertEqual("dump_2019_01.xml", ContractProviderRegistr._get_file_name(year=2019, month=1))
        self.assertRaises(Exception, ContractProviderRegistr._get_file_name, 2020, 100)
        self.assertRaises(Exception, ContractProviderRegistr._get_file_name, 999, 1)

    def test_trim_tag_name(self):
        self.assertEqual("testtext",
                         ContractProviderRegistr._trim_tag_name("{http://portal.gov.cz/rejstriky/ISRS/1.2/}testtext"))
        self.assertEqual("Currency",
                         ContractProviderRegistr._trim_tag_name("{http://portal.gov.cz/rejstriky/ISRS/1.2/}Currency"))
        self.assertEqual("Subject", ContractProviderRegistr._trim_tag_name("Subject"))
    ...
    def test_get_attributes_from_smluvni_strana(self):
        ...
        contract = Contract()
        res = ContractProviderRegistr._get_attributes_from_smluvni_strana(root, contract)
    ...
    def test_get_identifikator_from_zaznam(self):
        ...
        root = ET.fromstring(xml_text)
        contract = Contract()
        res = ContractProviderRegistr._get_identifikator_from_zaznam(root, contract)
    ...
    def test_get_attributes_from_subjekt(self):
        ...
        root = ET.fromstring(xml_text)
        contract = Contract()
        res = ContractProviderRegistr._get_attributes_from_subjekt(root, contract)
    ...
    def test_get_attributes_from_smlouva(self):
        ...
        root = ET.fromstring(xml_text)
        contract = Contract()
        res = ContractProviderRegistr._get_attributes_from_smlouva(root, contract)
    ...
    def test_get_contract_from_zaznam(self):
        ...
        root = ET.fromstring(xml_text)
        contract = ContractProviderRegistr._get_contract_from_zaznam(root)
